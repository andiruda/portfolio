...
def build_resume() -> None:
    ...
    story = [
        ...
        Paragraph(
            ...
            "Currently leads a four-engineer team for a 250-tenant, 3.3M-user platform spanning 7.3K Lambda functions, 620 REST APIs, 29 Angular applications, and 500+ microservices. Brings people leadership and technical "
    ...
    role(story, styles, "Rhythm Software", "Engineering Manager", "Aug 2025 - Present", [
        ...
        "Guide architecture and operations for a 250-tenant, 3.3M-user AWS platform spanning 7.3K Lambda functions, 620 REST APIs, 29 Angular applications, and 500+ microservices.",
