...
export const metadata: Metadata = {
  ...
  description:
    "Engineering leader and technical player-coach helping guide a 250-tenant, 3.3M-user AWS platform across 7.3K Lambda functions, 620 REST APIs, and 29 Angular applications.",
  keywords: [
    "Andi Ruda",
    "Engineering Manager",
